...
@section('body_page')
    <div class="container-fluid p-0">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1 class="h3"><strong>Update</strong> Product </h1>
            <a href="{{ route('product.index') }}" class="btn btn-primary">Back</a>
        </div>
        <form id="do-form" class="row" action="{{ route('product.update', $product['id']) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input id="position" value="{{ $product['position'] ?? 0 }}" name="position"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input readonly value="{{ $product['photo'] }}" id="thumbnail" class="form-control"
