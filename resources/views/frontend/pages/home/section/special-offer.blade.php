        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-12">
                ...
                <div class="single-banner right"
                    style="background-image:url('https://demo.graygrids.com/themes/shopgrids/assets/images/banner/banner-3-bg.jpg');margin-top: 30px;">
                    <div class="content">
            ...
            <div class="col-lg-4 col-md-12 col-12">
                <div class="offer-content">
                    <div class="image">
                        <img src="https://demo.graygrids.com/themes/shopgrids/assets/images/offer/offer-image.jpg" alt="#">
